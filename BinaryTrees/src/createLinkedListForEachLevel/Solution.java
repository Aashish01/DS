package createLinkedListForEachLevel;
...
public static ArrayList<Node<BinaryTreeNode<Integer>>> LLForEachLevel(BinaryTreeNode<Integer> root) {
	...
	public static void printArrayList(ArrayList<Node<BinaryTreeNode<Integer>>> list) {
	for(int i=0;i<list.size();i++) {
		Node<BinaryTreeNode<Integer>> head= list.get(i);
		String str="";
		while(head!=null) {
