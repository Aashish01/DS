package createAndInsertDuplicateNodeAtLeft;
...
public class Solution {
	...
	root =	helpinsertDuplicateNode(root);
	}
	public static BinaryTreeNode<Integer> helpinsertDuplicateNode(BinaryTreeNode<Integer> root) {
		if(root==null) {
			return root;
		}
		...
		node.right=null;
		root.left=node;
		helpinsertDuplicateNode(root.left.left);
		helpinsertDuplicateNode(root.right);
		return root;
	}
